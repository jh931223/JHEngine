...
public:
	...
	bool Render(ID3D11DeviceContext*, int, XMMATRIX, XMMATRIX, XMMATRIX, void* _textureArray)override;

private:
	bool InitializeShader(ID3D11Device*, HWND, const WCHAR*, const WCHAR*)override;
	void ShutdownShader()override;

	bool SetShaderParameters(ID3D11DeviceContext*, XMMATRIX, XMMATRIX, XMMATRIX, void* _textureArray)override;
